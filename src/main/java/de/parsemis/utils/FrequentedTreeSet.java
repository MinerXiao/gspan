...
/**
 * This class is a straight forward implementation of a frequented TreeSet
 *
 ...
 */
public class FrequentedTreeSet<Type extends Frequented> extends TreeSet<Type>
        implements FrequentedCollection<Type> {
     ...
     * @param freq
     */
    public FrequentedTreeSet(final Frequency freq) {
