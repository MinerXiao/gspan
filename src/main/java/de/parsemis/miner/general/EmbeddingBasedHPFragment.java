...
public class EmbeddingBasedHPFragment<NodeType, EdgeType> extends
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.HPFragment#add(de.de.parsemis.miner.DataBaseGraph)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.HPFragment#copy()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.HPFragment#graphIterator()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.HPFragment#toHPGraph()
     */
