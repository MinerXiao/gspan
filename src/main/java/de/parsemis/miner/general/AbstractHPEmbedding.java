...
public abstract class AbstractHPEmbedding<NodeType, EdgeType, DB extends DataBaseGraph<NodeType, EdgeType>>
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#freeSuperEdge(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#getDataBaseGraph()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#getSubGraph()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#getSubGraphEdge(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#getSuperGraph()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#getSuperGraphEdge(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#toEmbedding()
     */
