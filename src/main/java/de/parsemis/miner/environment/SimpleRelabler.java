...
public class SimpleRelabler<NodeType, EdgeType> implements
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.environment.Relabler#getEdgeLabel(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.environment.Relabler#getEdgeLabelIndex(java.lang.Object)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.environment.Relabler#getNodeLabel(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.environment.Relabler#getNodeLabelIndex(java.lang.Object)
     */
