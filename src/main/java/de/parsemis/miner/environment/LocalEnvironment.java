...
public class LocalEnvironment<NodeType, EdgeType> implements
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.utils.Relabler#getEdgeLabel(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.utils.Relabler#getEdgeLabelIndex(null)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.utils.GraphEnvironment#getGraph(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.utils.Relabler#getNodeLabel(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.utils.Relabler#getNodeLabelIndex(null)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.utils.GraphEnvironment#graphCount()
     */
