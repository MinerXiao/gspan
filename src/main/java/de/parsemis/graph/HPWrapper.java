...
class HPWrapper<NodeType, EdgeType> implements Graph<NodeType, EdgeType> {
    ...
    protected final static class MyEdge<NodeType, EdgeType> implements
         ...
         * (non-Javadoc)
         *
         * @see de.de.parsemis.graph.Edge#getDirection(de.de.parsemis.graph.Node)
         */
         ...
         * (non-Javadoc)
         *
         * @see de.de.parsemis.graph.Edge#getOtherNode(de.de.parsemis.graph.Node)
         */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#edgeIterator()
     */
    public Iterator<Edge<NodeType, EdgeType>> edgeIterator() {
        return new Iterator<Edge<NodeType, EdgeType>>() {
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#getEdge(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#getEdge(de.de.parsemis.graph.Node,
     *      de.de.parsemis.graph.Node)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#getEdgeCount()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#getID()
     */
    public int getID() {
        return master.getID();
    }
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#getMaxEdgeIndex()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#getMaxNodeIndex()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#getName()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#getNode(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#getNodeA(de.de.parsemis.graph.Edge)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#getNodeB(de.de.parsemis.graph.Edge)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#getNodeCount()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#nodeIterator()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Graph#toHPGraph()
     */
