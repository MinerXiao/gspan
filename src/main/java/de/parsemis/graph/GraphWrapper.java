...
class GraphWrapper<NodeType, EdgeType> implements
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPGraph#getNodePartion()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPGraph#isValidEdge(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPGraph#isValidNode(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPGraph#setEdgeLabel(int, EdgeType)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPGraph#setNodeLabel(int, NodeType)
     */
