...
class MutableGraphWrapper<NodeType, EdgeType> extends
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPMutableGraph#addEdgeIndex(int, int, EdgeType,
     *      int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPMutableGraph#addNodeAndEdgeIndex(int, NodeType,
     *      EdgeType, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPMutableGraph#addNodeIndex(NodeType)
     */
