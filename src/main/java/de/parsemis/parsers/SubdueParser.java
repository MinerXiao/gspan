...
public class SubdueParser<NodeType, EdgeType> implements
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.parsers.GraphParser#getEdgeParser()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.parsers.GraphParser#getNodeParser()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.parsers.GraphParser#parse(java.io.InputStream,
     *      de.de.parsemis.graph.GraphFactory)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.parsers.GraphParser#parse(java.lang.String,
     *      de.de.parsemis.graph.GraphFactory)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.parsers.GraphParser#serialize(de.de.parsemis.graph.Graph)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.parsers.GraphParser#serialize(java.io.OutputStream,
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.parsers.GraphParser#serializeFragments(java.io.OutputStream,
     *      java.util.Collection)
     */
