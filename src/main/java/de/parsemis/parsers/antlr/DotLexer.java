// $ANTLR 2.7.6 (2005-12-22): "Dot.g" -> "DotLexer.java"$
...
/**
 */
public class DotLexer extends antlr.CharScanner implements DotLexerTokenTypes, TokenStream {
    ...
    public DotLexer(LexerSharedInputState state) {
        ...
        literals.put(new ANTLRHashString("edge", this), new Integer(25));
        literals.put(new ANTLRHashString("s", this), new Integer(30));
        literals.put(new ANTLRHashString("se", this), new Integer(29));
        literals.put(new ANTLRHashString("sw", this), new Integer(31));
        literals.put(new ANTLRHashString("e", this), new Integer(28));
        literals.put(new ANTLRHashString("n", this), new Integer(26));
        literals.put(new ANTLRHashString("digraph", this), new Integer(23));
        literals.put(new ANTLRHashString("ne", this), new Integer(27));
        literals.put(new ANTLRHashString("w", this), new Integer(32));
        literals.put(new ANTLRHashString("nw", this), new Integer(33));
        literals.put(new ANTLRHashString("node", this), new Integer(24));
        literals.put(new ANTLRHashString("graph", this), new Integer(22));
        literals.put(new ANTLRHashString("strict", this), new Integer(21));
    }
    ...
    public final void mLCB(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
    ...
    public final void mRCB(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
        int _ttype;
        Token _token = null;
        int _begin = text.length();
        _ttype = RCB;
