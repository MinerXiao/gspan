...
import de.parsemis.miner.general.*;
...
public class DAGmFragment<NodeType, EdgeType> extends
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Fragment#add(de.de.parsemis.miner.DataBaseGraph)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Fragment#copy()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Fragment#embeddingToFragmentEdge(de.de.parsemis.graph.Embedding,
     *      de.de.parsemis.graph.Edge)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Fragment#embeddingToFragmentNode(de.de.parsemis.graph.Embedding,
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Fragment#fragmentToEmbeddingEdge(de.de.parsemis.graph.Embedding,
     *      de.de.parsemis.graph.Edge)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Fragment#fragmentToEmbeddingNode(de.de.parsemis.graph.Embedding,
     *      de.de.parsemis.graph.Node)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Fragment#toGraph()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Fragment#graphIterator()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.HPFragment#toFragment()
     */
