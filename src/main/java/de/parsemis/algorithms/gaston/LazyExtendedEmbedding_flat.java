...
public class LazyExtendedEmbedding_flat<NodeType, EdgeType> implements
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPEmbedding#freeSuperEdge(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPEmbedding#freeSuperNode(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.utils.Frequented#frequency()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPEmbedding#getDataBaseGraph()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.GastonEmbedding#getId()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.GastonEmbedding#getParentId()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.GastonEmbedding#getSubGraph()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPEmbedding#getSubGraphEdge(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPEmbedding#getSubGraphNode(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.GastonEmbedding#getSubNode()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPEmbedding#getSuperGraph()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPEmbedding#getSuperGraphEdge(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPEmbedding#getSuperGraphNode(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.GastonEmbedding#getSuperNode()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.GastonEmbedding#isInit()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPEmbedding#overlaps(de.de.parsemis.miner.general.HPEmbedding,
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.GastonEmbedding#release(de.de.parsemis.miner.environment.ThreadEnvironment)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.GastonEmbedding#setFrag(de.de.parsemis.algorithms.gaston.GastonFragment)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPEmbedding#toEmbedding()
     */
