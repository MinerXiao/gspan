...
public class DepthRefinement extends Refinement {
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.testing.gaston.Refinement#clone(int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.Refinement#compareTo(de.de.parsemis.algorithms.gaston.Refinement)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.Refinement#getDepth()
     */
    @Override
    public int getDepth() {
        return nodeA;
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.Refinement#getNodeA()
     */
    @Override
    public int getNodeA() {
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.Refinement#toString()
     */
    @Override
