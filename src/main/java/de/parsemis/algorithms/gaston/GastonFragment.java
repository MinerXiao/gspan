...
public class GastonFragment<NodeType, EdgeType> extends
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPFragment#add(de.de.parsemis.miner.general.DataBaseGraph)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPFragment#copy()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPFragment#getMaximalNonOverlappingSubSet()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPFragment#graphIterator()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPFragment#release(de.de.parsemis.miner.environment.ThreadEnvironment)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.HPFragment#toHPGraph()
     */
