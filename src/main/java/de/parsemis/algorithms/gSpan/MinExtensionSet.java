...
public class MinExtensionSet<NodeType, EdgeType> extends
    ...
    protected MinExtensionSet(final GThreadEnvironment<NodeType, EdgeType> tenv) {
        super(tenv);
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gSpan.MinExtension#compareTo(de.de.parsemis.algorithms.gSpan.MinExtension)
     */
    @Override
