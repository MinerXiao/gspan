...
public class GSpanGraph<NodeType, EdgeType> implements
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.DataBaseGraph#frequency()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.DataBaseGraph#getEdges()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.DataBaseGraph#getIndex()
     */
    public int getIndex() {
        return idx;
    }
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.DataBaseGraph#getNodes()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.DataBaseGraph#toGraph()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.DataBaseGraph#toHPGraph()
     */
