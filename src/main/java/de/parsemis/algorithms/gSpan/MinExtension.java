...
public class MinExtension<NodeType, EdgeType> extends
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.gSpan.GSpanEdge#hashCode()
     */
    @Override
    public int hashCode() {
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gSpan.GSpanEdge#release(de.de.parsemis.algorithms.gSpan.GThreadEnvironment)
     */
    @Override
    ...
    protected MinExtension<NodeType, EdgeType> set(final int nodeA,
                                                   ...
                                                   final int labelB, final int dir, final int gEdge, final int gNodeB) {
        super.set(nodeA, nodeB, labelA, edgeLabel, labelB, dir);
        this.gNodeBi = gNodeB;
        this.gEdgei = gEdge;
        return this;
    }
