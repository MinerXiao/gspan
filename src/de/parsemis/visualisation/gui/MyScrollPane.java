 ...
 *            .equals(..))
 */
public class MyScrollPane<NodeType, EdgeType> extends JScrollPane implements
    ...
    public MyScrollPane(final int index) {
        super();
        this
        ...
        // this.addPropertyChangeListener("visualization type", renderer);
