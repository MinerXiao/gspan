...
public class Block implements DrawingUnit {
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.visualisation.chemicalVisualisation.DrawingUnit#getGroups()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.visualisation.chemicalVisualisation.DrawingUnit#initGroups()
     */
