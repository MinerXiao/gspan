...
public class DotParser extends antlr.LLkParser implements DotLexerTokenTypes {
    ...
    private Map<String, String> nodeIDStr2LabelStr = new HashMap<String, String>();
    private Map nodeIDStr2AttrMap = new HashMap();
    // a linked list of EdgeDesc objects
    private Collection<EdgeDesc> edges = new LinkedList<EdgeDesc>();
