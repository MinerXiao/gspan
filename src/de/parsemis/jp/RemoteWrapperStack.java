...
public class RemoteWrapperStack<NodeType, EdgeType> extends
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.strategy.MiningStack#pop()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.strategy.MiningStack#push(de.de.parsemis.miner.SearchLatticeNode)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.strategy.MiningStack#size()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.strategy.MiningStack#split(de.de.parsemis.strategy.MiningStack)
     */
