...
public abstract class GenerationStep<NodeType, EdgeType> extends
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.GenerationPartialStep#call(de.de.parsemis.miner.SearchLatticeNode,
     *      de.de.parsemis.graph.Embedding)
     */
    @Override
    public void call(final SearchLatticeNode<NodeType, EdgeType> node,
                     final HPEmbedding<NodeType, EdgeType> embedding) {
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.MiningStep#getNext()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.GenerationPartialStep#reset()
     */
    @Override
    public void reset() {
        if (first != null) {
