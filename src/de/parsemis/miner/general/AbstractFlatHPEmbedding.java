...
public abstract class AbstractFlatHPEmbedding<NodeType, EdgeType, DB extends DataBaseGraph<NodeType, EdgeType>>
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#freeSuperNode(int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#getSubGraphNode(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#getSuperGraphNode(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#overlaps(de.de.parsemis.graph.HPEmbedding,
