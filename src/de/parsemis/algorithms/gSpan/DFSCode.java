...
public class DFSCode<NodeType, EdgeType> extends
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.SearchLatticeNode#allEmbeddings()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.SearchLatticeNode#extend(de.de.parsemis.miner.Extension)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.SearchLatticeNode#finalizeIt()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.general.SearchLatticeNode#getThreadNumber()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Canonizable#isCanonical()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.SearchLatticeNode#release()
     */
    @Override
    public void release() {
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.SearchLatticeNode#setFinalEmbeddings(java.util.Collection)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.SearchLatticeNode#setThreadNumber(int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.SearchLatticeNode#store(java.util.Collection)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.SearchLatticeNode#toHPFragment()
     */
    @Override
