...
public class GSpanHPEmbedding_hierarchical<NodeType, EdgeType>
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.gSpan.GSpanHPEmbedding#extend(de.de.parsemis.gSpan.GSpanExtension,
     *      int, int, de.de.parsemis.gSpan.GThreadEnvironment)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#getExtension(int, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.HPEmbedding#mapExtension(de.de.parsemis.miner.Extension)
     */
    public boolean mapExtension(final Extension<NodeType, EdgeType> ext) {
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.gSpan.GSpanHPEmbedding#release(de.de.parsemis.utils.ThreadEnvironment)
     */
