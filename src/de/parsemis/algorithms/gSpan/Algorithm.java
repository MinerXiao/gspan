...
import de.parsemis.miner.chain.*;
...
public class Algorithm<NodeType, EdgeType> implements
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Algorithm#getExtender(int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Algorithm#initialize(java.util.Collection,
     *      de.de.parsemis.graph.GraphFactory, de.de.parsemis.Settings)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Algorithm#initialNodes()
     */
