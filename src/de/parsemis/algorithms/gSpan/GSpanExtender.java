...
public class GSpanExtender<NodeType, EdgeType> extends
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Extender#getChildren(java.util.Collection)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.miner.Extender#getChildren(de.de.parsemis.miner.SearchLatticeNode)
     */
    public Collection<SearchLatticeNode<NodeType, EdgeType>> getChildren(
