...
public class CycleRefinement extends Refinement {
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.Refinement#getNodeB()
     */
    @Override
    public int getNodeB() {
        return nodeB;
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.Refinement#getToLabel()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.Refinement#isCycleRefinement()
     */
    @Override
