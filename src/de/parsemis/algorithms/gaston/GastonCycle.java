...
public class GastonCycle<NodeType, EdgeType> extends
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.GastonNode#extend(de.de.parsemis.algorithms.gaston.Leg,
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.algorithms.gaston.GastonNode#getExtensions()
     */
    @Override
