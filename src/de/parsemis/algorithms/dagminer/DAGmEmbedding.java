...
public class DAGmEmbedding<NodeType, EdgeType> implements
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Embedding#getDataBaseGraph()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Embedding#getSubGraph()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Embedding#getSubGraphEdge(de.de.parsemis.graph.Edge)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Embedding#getSubGraphNode(de.de.parsemis.graph.Node)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Embedding#getSuperGraph()
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Embedding#getSuperGraphEdge(de.de.parsemis.graph.Edge)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Embedding#getSuperGraphNode(de.de.parsemis.graph.Node)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.graph.Embedding#overlaps(de.de.parsemis.graph.Embedding,
