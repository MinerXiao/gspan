...
public class HalfIntMatrix implements IntMatrix {
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.utils.IntMatrix#exchangeRows(int, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.utils.IntMatrix#get(int, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.utils.IntMatrix#set(int, int, int)
     */
     ...
     * (non-Javadoc)
     *
     * @see de.de.parsemis.utils.IntMatrix#size()
     */
    public int size() {
        return size;
    }
